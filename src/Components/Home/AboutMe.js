        ...
        <div id='service' className="hero" >
            ...
            <div className="hero-content text-center text-neutral-content">
                <div className='grid text-center  gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 mx-4'>
                    <div data-aos="zoom-in-right" className="max-w-md rounded-md shadow-md text-black ">
                    ...
                    <div data-aos="zoom-in-left" className="max-w-md rounded-md  text-black shadow-md ">
                    ...
                    <div  data-aos="zoom-in-up" className="max-w-md rounded-md  text-black shadow-md">
