        ...
        <div id='service' className="hero" >
            ...
            <div className="hero-content text-center text-neutral-content">
                ...
                <div className='grid text-center  gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 mx-4'>
                    <div data-aos="zoom-in-right" className="max-w-md rounded-md shadow-md  bg-white dark:text-white dark:bg-black p-4 text-black ">
                    ...
                    <div  data-aos="zoom-in-up" className="max-w-md rounded-md  text-black bg-white dark:text-white dark:bg-black p-4 shadow-md">
